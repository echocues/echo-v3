...
<nav class="middleground">
    <h3>Echo</h3>
    <div>
        <button on:click={() => select(0)} bind:this={buttons[0]}>
        ...
        <button on:click={() => select(3)} bind:this={buttons[3]}>
    ...
    <div id="bottom">
        <button on:click={() => select(4)} bind:this={buttons[4]}>
            <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
